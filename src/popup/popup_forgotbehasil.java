 ...
 * @author dagi
 */
public class popup_forgotbehasil extends javax.swing.JFrame {

    public popup_forgotbehasil() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Berhasil diubah");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popup_forgotbehasil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popup_forgotbehasil().setVisible(true);
            }
        });
    }
