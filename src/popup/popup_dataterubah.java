 ...
 * @author dagi
 */
public class popup_dataterubah extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Data berhasil dirubah");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(popup_dataterubah.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new popup_dataterubah().setVisible(true);
            }
        });
    }
